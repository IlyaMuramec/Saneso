...
public:
	...
	**************************************************************************
	...
	cv::Point-structure
	***************************************************************************/
	Point2f interpolate(const Point& p, const TPS_INTERPOLATION tpsInter = BACK_WARP);
	...
	***************************************************************************/
	...
	void setSourceSize(const Size2f& pS);
...
private:
	...
	****************************************************************************/
	...
	Point2f interpolate_back_(const Point& p);
	Point2f interpolate_forward_(const Point& p);
	...
	// ROI of input and output images
	Size2f inputSize;
	Rect outputRoi;
};
